...
class VariantSelects extends HTMLElement {
 ...
 updateMeta() {
  ...
  getVariantMetafield() {
    ...
    const currentVariantMetafield = variantMetafields.find(obj => {
      if (obj.id == this.currentVariant.id) {
        return obj;
      }
    });
    console.log(currentVariantMetafield.qty);
    document.querySelector('.quantity__input').setAttribute('step', currentVariantMetafield.qty);
    document.querySelector('.quantity__input').setAttribute('min', currentVariantMetafield.qty);
    document.querySelector('.quantity__input').value = currentVariantMetafield.qty;
  }
}
